...
const MendiArtistHost = () => {
    ...
    const [filteredMendi,    setFilteredMendi]   = useState([]);
    ...
    const filterMendi = async () => {

        if (searchString === '') {
            setFilteredMendi(serviceList);
        } else {
            const matchedMendi = serviceList.filter((v) => {
    ...
    useEffect( () => {   
        if(mendiArtistList.length > 0){
            setserviceList(mendiArtistList);
        }
    }, [mendiArtistList])
                ...
                <div className="card-header">
                    <ul className="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                        <li className="nav-item mt-2">
                            <NavLink className="nav-link text-active-primary ms-0 me-10 py-5" to="/host/mehndi-artist/all">
                                                    ...
                                                    <span className='text-right'>
                                                        <div className="dropdown">
                                                            ...
                                                            <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                ...
                                                                <li><a className="dropdown-item" onClick={() => deleteMendiArtist(v)}> Delete </a></li>
                                                            </ul>
                                                        </div>
                                                    </span>
                                                </div> 
...
export default MendiArtistHost;