...
const CatererList = () => {
    ...
    const onChangeCityFilter     = (cityId) => history.push(`/caterers/${cityId}`);
    ...
    useEffect(() => {
        ...
        const fetchCaterers = async () => {
            try {
                ...
                if(cityId){
                    const response = await getServiceByNameAndCity('Caterers', cityId);
                    ...
                    const response = await getServiceByName('Caterers');
