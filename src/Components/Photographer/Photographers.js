...
const Photographers = () =>  {
    ...
    return (
        <>
            ...
            {param.typeOfPhotographer === 'booking' ? (
                <div>
            ...
            {showAddPhotographerModal && (
                <AddPhotographerModal
                    show={showAddPhotographerModal}
                    onDismissModal={openPhotographerModal}
                />
            )}
