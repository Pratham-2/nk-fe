                        ...
                        <div className="modal-body grey-background">
                            ...
                            <div className='card margin-t20'>
                                <div className='card-body'>
                                        ...
                                        <div className="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="ms-6">
                                                    ...
                                                    <div className="fw-bold text-muted text-left"><span className='margin-r10'><i className="las la-building"></i>{props.show.Locality}</span><i className="las la-city"></i>{props.show.City}</div>
                                                </div>
                                            </div>
                                        ...
                                        <div className={`${(props.catererDetails || props.venueDetails) ? 'col-4' : 'col-6'}`}>
                                            <div className="d-flex flex-aligns-center">
                                                ...
                                                <div className="ms-1 fw-bold">
                                                    ...
                                                    <div className="text-gray-400 text-left">{props.show.PriceRange}</div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    {(!props.decoratorDetails && !!props.show.Amenities) && (
                                        <div className='row margin-20'>
