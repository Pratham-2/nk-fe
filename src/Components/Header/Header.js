...
import RightSideDrawer from "../Global/RightSideDrawer";
...
const Header = ({ pathName }) => {
	...
	const [displayAsideHeader, setDisplayAsideHeader] = useState(false);

	const openAsideMenu = (v) => setDisplayAsideHeader(v);
	...
	return (
		<>
					...
					<div className="d-flex align-items-stretch justify-content-between flex-lg-grow-1 user-header">
						<div className="d-flex align-items-stretch" id="kt_header_nav">
							{displayUserHeader && (<>
								...
								<div className="header-menu align-items-stretch"  >
									<div className="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-600 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold fs-6 my-5 my-lg-0 align-items-stretch headerservicedd" id="#kt_header_menu">
										<div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" className="menu-item menu-lg-down-accordion me-lg-1">
											<Dropdown  className="menu-item menu-lg-down-accordion me-lg-1">
												<Dropdown.Toggle variant="light" className="menu-link"  > 											
														<span className="menu-title "> Services </span>
														<span className="menu-arrow d-lg-none"></span>
												</Dropdown.Toggle>
												<Dropdown.Menu className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													{globalServices.map((s,i)=>{
														return(
															<Dropdown.Item  className="menu-item" key={i}>
						...
						<div className="d-flex align-items-stretch justify-self-end flex-shrink-0 user-header">
							<div className="d-flex align-items-stretch flex-shrink-0">
								...
								{displayUserHeader && (<>
									<div className="d-flex align-items-center d-lg-none ms-3 me-n1" id="mobileHeaderBtn" title="Show header menu">
										<div onClick={() => openAsideMenu(true)} className="btn btn-icon btn-active-color-primary w-30px h-30px w-md-40px h-md-40px" id="kt_header_menu_mobile_toggle">
			...
			{displayAsideHeader && (<RightSideDrawer pushToPath={pushToPath} onToggle={openAsideMenu} />)}

			{/* {showAuthModal && ( <LoginModal  show = { showAuthModal } onDismissModal = {openAuthModal} /> )} */}
