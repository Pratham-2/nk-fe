...
const Caterers = () =>  { 
    ...
    return (
        <>
            <div className="card margin-l25 margin-r25">
                <div className="card-header">
                    ...
                    <div className='card-toolbar'>
                        ...
                        <div >
                            <button className="btn btn-primary btn-sm" style={{display: 'inline'}}  onClick={openCatererModal} >
                                <i className="la la-plus"></i>  New Caterers
                            </button>
                        </div>
                    </div>                    
                </div>
            ...
            {showAddCatererModal && ( <AddCatererModal show={showAddCatererModal} onDismissModal={openCatererModal} /> )}
