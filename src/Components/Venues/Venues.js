...
const Venues = () => {
    ...
    return (
        <>
                                ...
                                <div className="card me-md-6 text-left mb-4" >
                                    <div className="card-body padding-10">
                                        ...
                                        <div className="m-0 mt-4 padding-lr15">
                                            ...
                                            <div className="fw-bold fs-5 text-gray-600 text-dark mt-3 mb-2 address-height">
                                                {v.Address}
                                            </div>
                                                ...
                                                <div className='col-sm-4'>
                                                    <span className='text-right'>
                                                        <div className="dropdown">
                                                            <button className="btn btn-sm btn-bg-light" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }} type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            {showAddVenueModal && ( <AddVenueModal show={showAddVenueModal} onDismissModal={openVenueModal} /> )}
