...
import bannerImg from "../../Assets/images/bannerPhoto.jpg"
...
const PhotographerList = () => {
    ...
    const serviceClick = (venueId) =>  history.push(`/photo/${venueId}`);
    const onChangeCityFilter = (cityId) => history.push(`/photographer/${cityId}`)
    ...
    useEffect(() => {
        ...
        const fetchPhotographers = async() => {
            try {
                ...
                if(cityId){
                    const response = await getServiceByNameAndCity('Photographer', cityId);
                    ...
                    const response = await getServiceByName('Photographer');
	...
	return (<>
        {isLoading ? <Loader/> 
      :(<>
        <PageHeader bannerImage = { bannerImg } bannerTitle= {'Photographers'} position={'top'}
            imageAuthor = {{ title : '', link  : "" }}
        />
                        ...
                        <div className="col-12">	
                            <div className="card me-md-6 text-left mb-4" >
                                <div className="card-body padding-10 text-center">
                                    ...
                                    <h2 className="fw-bolder text-dark lh-base"> No Photographers found </h2>
                                    <NavLink to={'/'}>
                                    ...
                                    <div className="card-body padding-10 " >
                                        {/* <span className="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales"> */}
                                            <div className="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover  min-h-200px">
                                                <CustomSwiper images={f.Images} from='photographer-images'/>
                                            </div>
